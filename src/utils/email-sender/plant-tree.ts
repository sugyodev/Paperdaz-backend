...
export const sendPlantTree = async (user: any, maxLeaves:string) => {
  ...
  var mail = {
    ...
    to: user.email,
    subject: "Paperdaz, Planting A Tree",
    html: `
    ...
    * {
    ...
    <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 20px; line-height: 28px; font-family: 'Open Sans', sans-serif;"><strong>Planting A Tree </strong></span></p>
      </div>
    ...
    <p style="font-size: 14px; line-height: 160%;padding: 1em 0;"><span style="font-size: 18px; line-height: 28.8px;"> You’ve earned ${maxLeaves} leaves. We will be planting a tree on your honor. </span></p>
    <p style="font-size: 14px; line-height: 160%;"> </p>
    <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;"><span style="line-height: 17.8px; font-size: 18px;">Thank you for keeping everyone safe and the world green.</span></span></p>
      </div>
