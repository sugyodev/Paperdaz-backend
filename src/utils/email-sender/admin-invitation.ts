...
export const sendAdminInvite = async (user: any, business:any, invitationLink:string) => {
  ...
  var mail = {
    ...
    to: user.email,
    subject: "Paperdaz, Admin Invitation",
    html: `
...
<table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 20px; line-height: 28px; font-family: 'Open Sans', sans-serif;"><strong>Admin Invitation</strong></span></p>
  </div>
...
<div style="font-family:'Cabin',sans-serif;padding: 1em 0;">
    <div style="font-size: 14px; line-height: 160%;display: flex;align-items: center;">
        ...
        <div  class="u-col-larger" >
            <p>${business.companyName ?? business.firstName}, invites you to become an Admin</p>
        </div>
    </div>
</div>
...
<a style="font-size: 14px; line-height: 160%;" align="center">
