...
const sendReferralCredit = async (user: any, invitedUser: any,  earn:string, type: string, userIsBusiness: boolean, invitedUserIsBusiness: boolean) => {
  ...
  let html;
  let userImgRadius = '10'
  let inviteduserImgRadius = '10'
  let footer = await email_footer()

  if(userIsBusiness){
   userImgRadius = '50'
  }
  if(invitedUserIsBusiness){
   inviteduserImgRadius = '50'
  }
...
<table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 20px; line-height: 28px; font-family: 'Open Sans', sans-serif;"><strong>${earn} ${title} Earned</strong></span></p>
  </div>
  ...
  <div style="line-height: 160%; text-align: left; word-wrap: break-word;">
    <div style="font-size: 14px; line-height: 160%;display: flex;align-items: center;">
        <div class="u-col-smaller" style="display: inline-block;flex:none">
            <img src="${user.profilePicture}" style="width: 40px;height:40px;border-radius:${userImgRadius}px;padding: 2px;border: 1px solid #4caf50;object-fit: cover;"/>
        </div>
...
<div style="font-family:'Cabin',sans-serif;padding: 1em 0;">
    <div style="font-size: 14px; line-height: 160%;display: flex;align-items: center;">
        <div class="u-col-smaller" style="display: inline-block;flex:none">
            <img src="${invitedUser.profilePicture}" style="width: 40px;height:40px;border-radius:${inviteduserImgRadius}px;padding: 2px;border: 1px solid #4caf50;object-fit: cover;"/>
        </div>

        <div  class="u-col-larger" >
            <p>${invitedUser.companyName ?? invitedUser.firstName} have joined Paperdaz using your referral link..</p>
        </div>
    </div>
</div>
<p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;"><span style="line-height: 17.8px; font-size: 18px;">You have earned ${earn} ${title} as referral credits</span></span></p>
  </div>
...
export default sendReferralCredit;