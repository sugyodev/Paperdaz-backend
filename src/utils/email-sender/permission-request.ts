...
export const sendPermissionRequest = async (user: any, business:any, permissionLink:string, fileName:string) => {
  ...
  var mail = {
    ...
    to: user.email,
    subject: "Paperdaz, Private File Request",
    html: `
...
<div style="font-family:'Cabin',sans-serif;padding: 1em 0;">
    <div style="font-size: 14px; line-height: 160%;display: flex;align-items: center;">
        ...
        <div  class="u-col-larger" >
            <p>${business.companyName ?? business.firstName}, Request Permission to view the private <b>${fileName}</b> file</p>
        </div>
    </div>
</div>
...
<p style="font-size: 14px; line-height: 160%;" align="center"><span style="font-size: 18px; line-height: 28.8px;">
    <a href="${permissionLink}" style="line-height: 17.8px; font-size: 18px;width: 180px;background-color: #4caf50;display:inline-block;text-align: center;border-radius: 10px;padding: 0.9em 0;color:white;text-decoration: none;">Accept Request</a>
</span></p>
</div>
