...
export const sendPackageSubscriptionCancel = async (business: any, date: string) => {
  ...
  var mail = {
    ...
    to: business.email,
    subject: `Paperdaz,  Subscription Cancelled`,
    ...
    * {
    ...
    <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 20px; line-height: 28px; font-family: 'Open Sans', sans-serif;"><strong>Subscription Cancelled</strong></span></p>
      </div>
    ...
    <p style="font-size: 14px; line-height: 160%;padding: 1em 0;"><span style="font-size: 18px; line-height: 28.8px;"> We’re sad to see you go</span></p>
    <p style="font-size: 14px; line-height: 160%;"> </p>
    <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;"><strong><span style="line-height: 17.8px; font-size: 18px;"> This is to confirm that your subscription for ${business.companyName ?? business.firstName +' '+ business.lastName} have been cancelled on ${date}.</span></strong></span></p>
      </div>
