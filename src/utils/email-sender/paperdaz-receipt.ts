...
export const sendPaperdazReceipt = async (user: any, attachment: string) => {
  ...
  console.log('here attachment===>', attachment, user.role === DEFAULT_VALUES.users.roles.FREE_USER
    ? user.email
    : user.companyEmail)
...
<body class="clean-body u_body"
  ...
  var mail = {
    ...
    to:
      user.role === DEFAULT_VALUES.users.roles.FREE_USER
        ? user.email
        : user.companyEmail,
