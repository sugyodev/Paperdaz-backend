...
export const sendPermissionRequest = async (user: any, business:any, permissionLink:string, fileName:string) => {
  ...
  let bizImgRadius = '10'
  if(business.role === DEFAULT_VALUES.users.roles.PAID_USER){
    bizImgRadius = '50'
  }
  ...
  var mail = {
    ...
    to: user.email,
    subject: "Paperdaz, Private File Access Granted",
    html: `
...
<table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 20px; line-height: 28px; font-family: 'Open Sans', sans-serif;"><strong>Access Request</strong></span></p>
  </div>
  ...
  <div style="line-height: 160%; text-align: left; word-wrap: break-word;">
    <div style="font-size: 14px; line-height: 160%;display: flex;align-items: center;">
        <div class="u-col-smaller" style="display: inline-block;flex:none">
            <img src="${user.profilePicture}" style="width: 40px;height:40px;border-radius:${imgRadius}px;padding: 2px;border: 1px solid #4caf50;object-fit: cover;"/>
        </div>
...
<div style="font-family:'Cabin',sans-serif;padding: 1em 0;">
    <div style="font-size: 14px; line-height: 160%;display: flex;align-items: center;">
        <div class="u-col-smaller" style="display: inline-block;flex:none">
            <img src="${business.profilePicture}" style="width: 40px;height:40px;border-radius:${bizImgRadius}px;padding: 2px;border: 1px solid #4caf50;object-fit: cover;"/>
        </div>

        <div  class="u-col-larger" >
            <p>${business.companyName ?? business.firstName}, Granted you access to view the private <b>${fileName}</b> file</p>
        </div>
    </div>
</div>
<!-- <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;"><span style="line-height: 17.8px; font-size: 18px;">You have earned 500 leaves as referral credits</span></span></p> -->
<p style="font-size: 14px; line-height: 160%;" align="center"><span style="font-size: 18px; line-height: 28.8px;">
    <a href="${permissionLink}" style="line-height: 17.8px; font-size: 18px;width: 180px;background-color: #4caf50;display:inline-block;text-align: center;border-radius: 10px;padding: 0.9em 0;color:white;text-decoration: none;">View File</a>
</span></p>
</div>
